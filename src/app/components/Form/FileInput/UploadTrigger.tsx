...
export function UploadTrigger() {
  return (
    <label
      htmlFor="photo"
      className="group flex flex-1 cursor-pointer flex-col items-center gap-3 rounded-lg border border-zinc-300 px-6 py-4 text-center text-zinc-500 shadow-md hover:border-violet-200 hover:bg-violet-25 hover:text-violet-500 hover:shadow-none"
    >
